...
public class JCloudsSlaveTemplateTest extends HudsonTestCase {
	...
	public void testConfigRoundtrip() throws Exception {
		...
		JCloudsCloud originalCloud = new JCloudsCloud("rackspace-profile", "rackspace-cloudservers-us",
		...
		assertEqualBeans(originalCloud, JCloudsCloud.getByName("rackspace-profile"),
                "profile,providerName,identity,credential,privateKey,publicKey,endPointUrl");

		assertEqualBeans(originalTemplate, JCloudsCloud.getByName("rackspace-profile").getTemplate(name),
