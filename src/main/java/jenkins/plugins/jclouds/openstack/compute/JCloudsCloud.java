...
public class JCloudsCloud extends Cloud {
	...
	/**
	 * Gets {@link jenkins.plugins.jclouds.openstack.compute.JCloudsSlaveTemplate} that has the matching {@link Label}.
	 */
	...
	public static class DescriptorImpl extends Descriptor<Cloud> {
		...
		public String getDisplayName() {
			return "Cloud (OpenStack jclouds)";
		}
        ...
        private Iterable<String> apiAndProviderIds() {
            // correct the classloader so that extensions can be found
            Thread.currentThread().setContextClassLoader(Apis.class.getClassLoader());
            // TODO: apis need endpoints, providers don't; do something smarter
            // with this stuff :)
            Builder<String> builder = ImmutableSet.<String> builder();
            builder.add("openstack-nova");
            builder.addAll(Iterables.transform(Providers.apiMetadataAssignableFrom(typeToken(NovaApiMetadata.class)), Providers.idFunction()));
		...
		public ListBoxModel doFillProviderNameItems() {
			...
			Iterable<String> supportedProviders = apiAndProviderIds();
